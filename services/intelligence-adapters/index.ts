/**
 * Genesis Phase 2 — Increments 3 & 4. Public entry point for adapters that
 ...
 * (`08_ADAPTER_STRATEGY.md` adapter #1) and the Data Trust Score Adapter's
 * pure translator (adapter #2's inner half only — see
 * `data-trust-score-adapter.ts`'s own header for the DB-touching-outer-layer
 * scope note). Nothing in this module opens a database, imports Next.js, or
 * executes a legacy engine.
 */
